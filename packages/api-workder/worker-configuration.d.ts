/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cbbdf4a53df4a3526b26adfec32b096e)
// Runtime types generated with workerd@1.20250730.0 2025-07-26 
declare namespace Cloudflare {
	interface Env {
		DATABASE_URL: string;
		HUNYUAN_LITE_BASE_URL: string;
		HUNYUAN_LITE_APP_KEY: string;
		DB: D1Database;
		AI: Ai;
	}
}
