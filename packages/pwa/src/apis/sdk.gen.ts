...
export const aiControllerGenTransaction = <ThrowOnError extends boolean = false>(options: Options<AiControllerGenTransactionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AiControllerGenTransactionResponses, unknown, ThrowOnError>({
