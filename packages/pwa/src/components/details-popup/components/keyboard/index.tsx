    ...
    const handleKeyPress = (key: string | number) => {
        if (typeof key === 'number') {
            ...
            if (!inputValue.includes('.')) {
                ...
                if (inputValue === '' || inputValue === '0' || ['+', '-'].includes(inputValue.slice(-1))) {
                        ...
                        <Fragment key={item}>
                            {
                                item === "delete" ? (
                                    ...
                                    <div
                                        className="bg-primary h-12 flex items-center justify-center rounded cursor-pointer text-white col-span-2 hover:bg-primary/90 transition-colors"
                                        onClick={() => handleKeyPress(item)}
                                    >
                                        保存
                                    </div>
